# 2021-1 Moigosa Backend (Node.js)
...
만약 로컬 데이터베이스를 사용하려면 `POSTGRES_HOST=localhost`로 설정하고 `localhost:5432` 주소에서 PostgreSQL을 실행합니다.
...
[documents/erd.html](documents/erd.html)
